...
<%
    	ArrayList<String> al = (ArrayList<String>)request.getAttribute("lists");
...
<link rel="stylesheet" type="text/css" href="./css/final.css?v=3">
<script src="./js/final.js?v=3"></script>
<title>최종예약페이지</title>
</head>
<body>
<header>
...
<form id="f">
<input type="hidden" value="<%out.print(al.get(0));%>" name="rname">
<input type="hidden" value="<%out.print(al.get(1));%>" name="rtel">
<input type="hidden" value="<%out.print(al.get(2));%>" name="rperson">
<input type="hidden" value="<%out.print(al.get(3));%>" name="rnum">
<input type="hidden" value="<%out.print(al.get(4));%>" name="rmt">
<input type="hidden" value="<%out.print(al.get(5));%>" name="rplace">
<input type="hidden" value="<%out.print(al.get(6));%>" name="rdong">
<input type="hidden" value="<%out.print(al.get(7));%>" name="rfd">
<input type="hidden" value="<%out.print(al.get(8));%>" name="rld">
<input type="hidden" value="<%out.print(al.get(9));%>" name="rpay">
<input type="hidden" value="<%out.print(al.get(10));%>" name="rprice">
<section>
	<div class="all">
		<p>야영장예약하기</p>
		...
		<div class="b">
		<input type="button" class="btn" value="예약완료" onclick="complete()">
...
if(msg =="a"){
	p.innerText="무통장 입금";
	o.innerText="신한은행 : 102-202306-0606 (국립공원공단)";
}
else if(msg=="b"){
	p.innerText="신용카드";
	o.innerText = "결제완료";
